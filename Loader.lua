...
getgenv()['Check_Setting'] = function(Name)
    if not _G.Dis and not isfolder('NAM Hub BF Premium') then
        makefolder('Switch Hub BF Premium')
    end
    if not _G.Dis and not isfile('NAM Hub BF Premium/'..Name..'.json') then
        writefile('Switch Hub BF Premium/'..Name..'.json',JsonEncode(_G.Setting_table))
    end
end
getgenv()['Get_Setting'] = function(Name)
    if not _G.Dis and isfolder('NAM Hub BF Premium') and isfile('NAM Hub BF Premium/'..Name..'.json') then
        _G.Setting_table = JsonDecode(readfile('NAM Hub BF Premium/'..Name..'.json'))
...
getgenv()['Update_Setting'] = function(Name)
    if not _G.Dis and isfolder('NAM Hub BF Premium') and isfile('NAM Hub BF Premium/'..Name..'.json') then
        writefile('NAM Hub BF Premium/'..Name..'.json',JsonEncode(_G.Setting_table))
	elseif not _G.Dis then
        Check_Setting(Name)
    end
end
